    ...
    <>
        ...
        <div className="row">
          <div className="col-3">
            <div className="w-100 d-inline-flex align-items-center justify-content-end gap-3">
                <svg width={'2rem'} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" enableBackground="new 0 0 32 32" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <line fill="none" stroke="#D4AF37" strokeWidth="2" strokeMiterlimit="10" x1="6" y1="16" x2="28" y2="16"></line> <polyline fill="none" stroke="#D4AF37" strokeWidth="2" strokeMiterlimit="10" points="14,24.5 5.5,16 14,7.5 "></polyline> </g></svg>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <button className="p-3 w-100 bg-primary-color border-0 accent-color fs-5 btn-primary" onClick={nextStep} disabled={!suitType}>Continue</button>
          </div>
        </div>
      </div>
    </>
